...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/24afd11455ac34a280fa83e4e8d75ccc_r.jpg)
表1
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/6b735fb9503b0930e741faa474fed28e_r.jpg)
表2

但是仅仅符合1NF的设计，仍然会存在数据冗余过大，插入异常，删除异常，修改异常的问题，例如对于表3中的设计：

![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/5b16f655b57a957bfa340d0a996a0eea_r.jpg)
表3
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/12513de20079d12b99d946072df7311a_b.jpg)
图1
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/10b52b39b18b8ea9fb17b46babf4d20f_b.jpg)
图2
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/51f8105fbbe92adaa3e343ea2db3bf49_b.jpg)
图3
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/51e2689ac9416a91800e63101bee9db7_b.jpg)
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/2f4b4a887f6a61674a49d03d79e3fe17_b.jpg)

图5

表4表示了模式分解以后新的数据

![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/44af74509a4e21372ed372be8560539d_b.jpg)

表4

（这里还涉及到一个如何进行模式分解才是正确的知识点，先不介绍了）现在我们来看一下，进行同样的操作，是否还存在着之前的那些问题？

1. 李小明转系到法律系
只需要修改一次李小明对应的系的值即可。——有改进数据冗余是否减少了？
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/5b20707ff3d9afb51ef7bfda726c3e34_b.jpg)

图6

新的数据表如表5

![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/8bca802bcff92a8945bf808d18d7ec62_b.jpg)
...
![](http://omqz8y2im.bkt.clouddn.com/blog/database-design/68d080d437732aad8cfe451b427849d6_b.jpg)
